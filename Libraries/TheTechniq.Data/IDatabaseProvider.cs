...
public partial interface IDatabaseProvider
{
    ...
    IQueryable<TEntity> GetTable<TEntity>(bool isLogDB = false) where TEntity : BaseEntity;
    ...
    Task<DataSet> ExecuteStoredProcedureForDataSetAsync(string procedureName, bool isLogDB = false, params DataParameter[] dataParameters);
    Task<DataSet> ExecuteStoredProcedureForDataSetAsync22(string procedureName, bool isLogDB = false, params DataParameter[] dataParameters);
    //Task<DataSet> ExecuteSqlQueryForDataSetAsync(string procedureName, bool isLogDB = false, params DataParameter[] dataParameters);
    DataSet ExecuteStoredProcedureForDataSet(string procedureName, params DataParameter[] dataParameters);
    ...
    DataSet ExecuteLogStoredProcedureForDataSet(string procedureName, params DataParameter[] parameters);
    #endregion
