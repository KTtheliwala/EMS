...
namespace TheTecniQ.Data.Configuration;

public partial class DataConfig : IConnectionStringAccessor
{
    /// <summary>
    ...
    public string ExternalDbConnectionString { get; set; } = string.Empty;
    ...
    /// </summary>
    [JsonIgnore]
    public static string Name => nameof(ConfigurationManager.ConnectionStrings);

    /// <summary>
    /// Gets an order of configuration
    /// </summary>
    /// <returns>Order</returns>
    public static int GetOrder() => 0; //display first
}