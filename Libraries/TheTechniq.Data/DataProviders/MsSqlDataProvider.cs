...
/// </summary>
public partial class MsSqlDataProvider : BaseDataProvider, IDatabaseProvider
{
    #region Utilities
    ...
    public override IQueryable<TEntity> GetTable<TEntity>(bool isLogDB = false)
    {
        var table = (ITable<TEntity>)base.GetTable<TEntity>(isLogDB);
    ...
    public virtual Task<int?> GetTableIdentAsync<TEntity>() where TEntity : BaseEntity
    {
        ...
        var tableName = GetEntityDescriptor<TEntity>().Name;
