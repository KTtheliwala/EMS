...
public partial class MySqlDataProvider //: BaseDataProvider, IDataProvider
{
    /*
    #region Fields
    ...
    public virtual string BuildConnectionString(IConnectionStringInfo connectionString)
    {
        ...
        {
            Server = connectionString.ServerName,
            //Cast DatabaseName to lowercase to avoid case-sensitivity problems
            Database = connectionString.DatabaseName.ToLowerInvariant(),
            AllowUserVariables = true,
            UserID = connectionString.Username,
