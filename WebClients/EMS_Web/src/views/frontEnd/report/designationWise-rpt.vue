...
filterData.value.push({
  ...
  fieldValue: enrollFilter.value
    ...
    PostData(UrlConstants.apiReportsDesignationWiseList, Postdata, "", (data: any) => {        
...
if (dateFilter?.value != null) {
    ...
    ExportData(UrlConstants.apiReportsDesignationWiseList,Postdata, ("DesignationRpt_"+(moment(Date.now()).utcOffset(0, true).format("YY_MMM_DD_hhmmss A"))),"",(exportType == 1)?"xlsx":"pdf", (data: any) => {        
                       // gridDataList.value = data;
  });
}
