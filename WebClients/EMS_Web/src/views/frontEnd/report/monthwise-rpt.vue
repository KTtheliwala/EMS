               ...
               :selectOtherMonths="true" :showIcon="true" class="w-full" inputId="dateRange2"></Calendar>
                        ...
                        <div class="col-12 md:col-2">                            
                            <div class="field">
                             ...
                             optionLabel="Text" optionValue="Value"
                                name="DepartmentID" v-model="DepartmentID" 
                                :callBack="getDesignationListData"
                                :isWatch="false" 
                                 />
                            </div>
                        </div>
                        <div class="col-12 md:col-2">                            
                            <div class="field">
                             ...
                             optionLabel="Text" optionValue="Value"
                                name="DesignationID" v-model="DesignationID" 
                                :isWatch="false" 
                                 />
                            </div>
                        </div>
...
filterData.value.push({
  ...
  fieldValue: enrollFilter.value
    ...
    PostData(UrlConstants.apiReportsList, Postdata, "", (data: any) => {        
...
if (dateFilter?.value != null) {
    ...
    ExportData(UrlConstants.apiReportsList,Postdata, ("MonthwiseRpt_"+(moment(Date.now()).utcOffset(0, true).format("YY_MMM_DD_hhmmss A"))),"",(exportType == 1)?"xlsx":"pdf", (data: any) => {        
                       // gridDataList.value = data;
  });
}
